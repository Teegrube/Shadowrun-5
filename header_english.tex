...
% Absätze machen keinen Unterschied mehr
...
% Shadowrun specific homebrew marker
\newcommand{\homebrew}[1]{\textit{\textbf{#1}}}


\author{%
  Axel Vogt \\%
  \href{mailto:axel@worx4all.de}{axel@worx4all.de}
}
\publishers{Me, myself and I}
